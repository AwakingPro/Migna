...
<li><a href="../inventario/inventario.php">Inventario</a></li>
  ...
  <div id="datos_com"><strong>Todos los Clientes Suspendidos</strong><span class="right_1">Exportar  <a href="reporteexcelsuspendidos.php"><img src="../../../imagenes/exportar.png" width="14" height="14" /></a></span><br /><br />
  </div>
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
         ...
         <tr>
        <?php $ticket=mysql_query("SELECT * FROM SP_dato_cliente WHERE estado='Suspendido' ORDER BY cliente ASC ");
