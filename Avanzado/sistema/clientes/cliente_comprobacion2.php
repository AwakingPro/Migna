...
//==============================================================================================
$ValidarAcronis = mysql_query("SELECT * FROM SP_servicio_acronis WHERE rut = '$rut' OR cliente = '$cliente'");
if(mysql_num_rows($ValidarAcronis)>0){
	header("Location: ver_clientes_acronis.php?cliente=$cliente&rut=$rut");
}
else{
	if (isset($cs))
	{
