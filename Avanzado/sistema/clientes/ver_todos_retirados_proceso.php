...
<?php include '../../../include/estructura/banner.php';?>
  ...
  <div id="datos_com"><strong>Todos los Clientes en proceso de Retiro</strong><span class="right_1">Exportar  <a href="reporteexcelproceso.php"><img src="../../../images/excel.png.jpg" width="15" height="15" /></a></span><br /><br />
  </div>
    <table id="example" class="display" cellspacing="0" width="100%">
        <thead>
         ...
         <tr>
        <?php $ticket=mysql_query("SELECT * FROM SP_dato_cliente WHERE estado='Retiro Solicitado' ORDER BY cliente ASC ");
