...
$fecha_reporte=date("d-m-Y");
	...
	$consulta = "SELECT * FROM SP_dato_cliente WHERE estado='Retiro Solicitado' ORDER BY cliente ASC ";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getActiveSheet()->setTitle('Retiro Solicitado');
		...
		header("Content-Disposition: attachment; filename=clientes_netland_retiro_solicitado.xlsx");
