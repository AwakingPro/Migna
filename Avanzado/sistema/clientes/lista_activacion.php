...
while ($row = mysql_fetch_row($comercial)){
    ...
    <td><center>
                             <a href="lista_activacion.php?id_morosos=<?php echo $id_morosos2; ?>"><img src="../../../imagenes/ver.png"  /></a>
           </center></td>
...
<div id="busqueda_clientes">
    <div id="datos_com"><strong>Clientes por Activar</strong><br /></div>
      <br />
      <?php 
	 
	  $query_id_morosos=mysql_query("SELECT * FROM morosos where id_morosos='$id_morosos' and id_status=3 and accion='Activar'");
      ...
      <table id="example2" class="display" cellspacing="0" width="100%">
        <thead>
         ...
         <tr>
        <?php $morosos=mysql_query("SELECT * FROM morosos where id_morosos='$id_morosos' and  id_status=3 and accion='Activar'");
...
while ($row = mysql_fetch_row($morosos)){
  ...
  <?php } else { echo "No Tienes clientes por Activar."; }?>
 </div>
</div> 
</div>
