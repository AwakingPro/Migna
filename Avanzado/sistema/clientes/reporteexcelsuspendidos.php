...
$fecha_reporte=date("d-m-Y");
	...
	$consulta = "SELECT * FROM SP_dato_cliente WHERE estado='Suspendido' ORDER BY cliente ASC ";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getActiveSheet()->setTitle('CLientes Suspendidos');
		...
		header("Content-Disposition: attachment; filename=clientes_netland_suspendidos.xlsx");
