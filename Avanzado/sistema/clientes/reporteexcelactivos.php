...
$fecha_reporte=date("d-m-Y");
	...
	$consulta = "SELECT * FROM SP_dato_cliente WHERE estado='Activo' ORDER BY cliente ASC ";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getActiveSheet()->setTitle('Clientes Activos');
		...
		header("Content-Disposition: attachment; filename=clientes_netland_activos.xlsx");
