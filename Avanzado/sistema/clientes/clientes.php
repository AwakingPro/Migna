...
<div id="Menu"> 
 ...
 <p class="Nota">Nota : Escriba las iniciales o coincidencia de caractéres en el campo de búsqueda.</p>
  ...
  <tr>
    ...
    <td><input name="rut" type="text" class="formulario_chico_intranet" id="course1" size="60" />
      <input type="submit" class="boton_intranet" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buscar Registro&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" /></td>
  </tr>
  <tr>
    <td height="18" class="LINK">&nbsp;</td>
  ...
  <tr>
    <td height="18" class="LINK">Código de Servicio : </td>
    <td><input name="cs" type="text" class="formulario_chico_intranet" id="course2" size="60" />
      <input type="submit" class="boton_intranet" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buscar Registro&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" /></td>
  </tr>
  <tr>
    <td height="18" class="LINK">&nbsp;</td>
...
<div id="datos_com"><strong>Opción Búsqueda 2 :</strong>  <br />
  ...
  <table width="1012" border="0">
  <tr>
    <td width="151" class="iconos_top">Estado del Servicio : </td>
    <td width="851"><!--input type="button" value="Get Value" /-->
      <label for="OPCION"></label>
      <select name="OPCION" class="formulario_grande_intranet" id="OPCION">
