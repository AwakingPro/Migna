...
$fecha_reporte=date("d-m-Y");
	...
	$consulta = "SELECT * FROM SP_dato_cliente  ORDER BY cliente ASC ";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->getActiveSheet()->setTitle('Todos los Clientes');
		...
		header("Content-Disposition: attachment; filename=clientes_netland_todos.xlsx");
