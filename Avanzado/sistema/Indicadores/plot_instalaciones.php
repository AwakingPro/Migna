...
$sql3 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$enero_1' AND '$enero_2'";
$resultado3 = mysql_query($sql3);

$select3=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$enero_1' AND '$enero_2'");
if (mysql_num_rows($select3)>0){
 $row = mysql_fetch_array($resultado3);
     $enero= $row[0];
	 global  $enero;
	  }
$sql4 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$febrero_1' AND '$febrero_2'";
$resultado4 = mysql_query($sql4);

$select4=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$febrero_1' AND '$febrero_2'");
if (mysql_num_rows($select4)>0){
 $row = mysql_fetch_array($resultado4);
     $febrero= $row[0];
	 global  $febrero;
	  }
$sql5 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$marzo_1' AND '$marzo_2'";
$resultado5 = mysql_query($sql5);

$select5=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$marzo_1' AND '$marzo_2'");
if (mysql_num_rows($select5)>0){
 $row = mysql_fetch_array($resultado5);
	 ...
	 global  $marzo;
	  ...
	  $sql6 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$abril_1' AND '$abril_2'";
$resultado6 = mysql_query($sql6);

$select6=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$abril_1' AND '$abril_2'");
if (mysql_num_rows($select6)>0){
 $row = mysql_fetch_array($resultado6);
	 ...
	 global  $abril;
	  	  ...
	  	  $sql7 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$mayo_1' AND '$mayo_2'";
$resultado7 = mysql_query($sql7);

$select7=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$mayo_1' AND '$mayo_2'");
if (mysql_num_rows($select7)>0){
 $row = mysql_fetch_array($resultado7);
	 ...
	 global  $mayo;
		  	  ...
		  	  $sql8 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$junio_1' AND '$junio_2'";
$resultado8 = mysql_query($sql8);

$select8=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$junio_1' AND '$junio_2'");
...
$sql9 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$julio_1' AND '$julio_2'";
$resultado9 = mysql_query($sql9);

$select9=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$julio_1' AND '$julio_2'");
if (mysql_num_rows($select9)>0){
 $row = mysql_fetch_array($resultado9);
     $julio= $row[0];
	 global  $julio;
	  }	  
$sql10 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$agosto_1' AND '$agosto_2'";
$resultado10 = mysql_query($sql10);

$select10=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$agosto_1' AND '$agosto_2'");
if (mysql_num_rows($select10)>0){
 $row = mysql_fetch_array($resultado10);
     $agosto= $row[0];
	 global  $agosto;
	  }	
$sql11 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$septiembre_1' AND '$septiembre_2'";
$resultado11 = mysql_query($sql11);

$select11=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$septiembre_1' AND '$septiembre_2'");
if (mysql_num_rows($select11)>0){
 $row = mysql_fetch_array($resultado11);
     $septiembre= $row[0];
	 global  $septiembre;
	  }		 
$sql12 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$octubre_1' AND '$octubre_2'";
$resultado12 = mysql_query($sql12);

$select12=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$octubre_1' AND '$octubre_2'");
if (mysql_num_rows($select12)>0){
 $row = mysql_fetch_array($resultado12);
     $octubre= $row[0];
	 global  $octubre;
	  }	
$sql13 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$noviembre_1' AND '$noviembre_2'";
$resultado13 = mysql_query($sql13);

$select13=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$noviembre_1' AND '$noviembre_2'");
if (mysql_num_rows($select13)>0){
 $row = mysql_fetch_array($resultado13);
     $noviembre= $row[0];
	 global  $noviembre;
	  }		  
$sql14 = "SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$diciembre_1' AND '$diciembre_2'";
$resultado14 = mysql_query($sql14);

$select14=mysql_query("SELECT COUNT(*) FROM SP_dato_cliente WHERE  fecha_inst  BETWEEN '$diciembre_1' AND '$diciembre_2'");
