...
$sql=mysql_query("SELECT nombre FROM SIS_procedimientos ");
...
<?php include '../../include/estructura/menu_sistema.php';?>
 <?php include '../../include/estructura/submenu_sistema_procedimientos_ingreso.php';?>      
  
  <div id="rpe"> <p class="iconos_top">
	</br>
	<div id="titulo_ticket_abiertos_left"><span class="iconos_top">Ingresar datos </span></div>
	<p class="iconos_top"><form method="post" enctype="multipart/form-data"  action="comprobacion_ingreso_procedimientos.php" >     <table width="740" border="0">
  <tr>
    <td width="8">&nbsp;</td>
    <td width="126">Nombre de Procedimiento</td>
    <td colspan="2"><span id="sprytextfield2">
    <label for="proc"></label>
    <input name="proc" type="text" class="formulario" id="proc" />
  ...
  <tr>
	...
	if (empty($id)){}
		...
		echo "<div id='dialog' title='Procedimientos'>Registro Ingresado Exitosamente.</div>";
...
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "date", {validateOn:["blur", "change"], format:"yyyy-mm-dd"});
</script>
</body>
</html>
