...
if (isset($_GET['Si']))
{
header("Location: factibilidades_pendientes.php?id=3&ticket_filter=$ticket_filter");
...
if (isset($_GET['No']))
{
header("Location: factibilidades_pendientes.php?ticket_filter=$ticket_filter");
