...
echo "<td bgcolor='#C9101A'><font color='#FFFFFF'>Proveedor</td> \n";
echo "<td bgcolor='#C9101A'><font color='#FFFFFF'>Bodega</td> \n";
...
echo "<td><div id='divi'>$row[6]</div></td> \n";
echo "<td><div id='divi'><a 
 href='inventario_comprobacion_editar_activos.php?mac=$row[1]&serial=$row[0]'><center><img src='../../../imagenes/editar.jpg'></a></div></center></td> \n";
echo "<td><div id='divi'><a   href='comprobacion_eliminar.php?mac=$row[1]&serial=$row[0]'><center><img src='../../../imagenes/eliminar.png'></a></div></center></td> \n";
...
<?php
   ...
   if ($id==1){
	   ...
	   <a  name='link' href='comprobacion_eliminado.php?serial=$id3&mac=$id2&ide=1' >SI</a>"." &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp        "."<a  name='link' href='comprobacion_eliminado.php?serial=$id3&mac=$id2' >NO</a>
	   </center></div>
	   ";
