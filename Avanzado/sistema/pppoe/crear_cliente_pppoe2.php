...
$sql_srv=mysql_query("SELECT nombre_server FROM PPPoE_SRV  ");
$sql_alias=mysql_query("SELECT alias FROM SP_dato_cliente WHERE cliente='$cliente'  ");
if (!isset($_SESSION)) {
  session_start();
}
...
<li><a href="../inventario/inventario.php">Inventario</a></li>
 ...
 <?php include '../../../include/estructura/submenu_clientes_busqueda_pppoe_crear.php';?>
  ...
  <div id="busqueda_clientes">
    <div id="datos_com"><strong>Paso 2 : Crear Credenciales de Acceso PPPoE</strong>  <br />
      <br />
    </div>
    <FORM name=tuformulario autocomplete="off" ACTION="comprobacion_crear_cliente_pppoe2.php" METHOD="POST">
      <table width="1088" border="0">
  <tr>
    <td width="185" class="iconos_top">Cliente</td>
    <td width="893"><!--input type="button" value="Get Value" /--><span id="sprytextfield1">
    <label for="cliente"></label>
    <input name="cliente" type="text" class="formulario_grande_intranet" id="cliente" readonly="readonly" value="<?php echo $cliente;?>"/>
  ...
  <tr>
    <td height="18" class="LINK">Enlace</td>
    <td><span id="sprytextfield2">
    <label for="alias"></label>
    <select class="formulario_grande_intranet" name="alias"> 
	<?php while($row3 = mysql_fetch_array($sql_alias)){ ?>
        <option value="<?php echo $row3['alias']; ?>" ><?php echo $row3['alias']; ?>
          <?php } ?>
          </option>
      </select>
  ...
  <tr>
    <td height="18" class="LINK">Seleccione Servidor</td>
    <td><select class="formulario_grande_intranet" name="srv"> 
	<?php while($row = mysql_fetch_array($sql_srv)){ ?>
  ...
  <tr>
    ...
    <label for="user_pppoe"></label>
    <input name="user_pppoe" type="text" class="formulario_chico_intranet" id="user_pppoe" />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
  </tr>
  <tr>
    <td height="18" class="LINK">Contraseña</td>
    <td><span id="sprytextfield4">
    <label for="pass_pppoe"></label>
    <input name="pass_pppoe" type="text" class="formulario_chico_intranet" id="pass_pppoe" />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
  </tr>
  <tr>
    <td height="18" class="LINK">Dirección IP</td>
    <td><span id="sprytextfield5">
    <label for="ip_pppoe"></label>
    <input name="ip_pppoe" type="text" class="formulario_chico_intranet" id="ip_pppoe" />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
  </tr>
  <tr>
    <td height="18" class="LINK">Plan</td>
    
      <td>
      <select class="formulario_chico_intranet" name='plan'>
       <option value="1" >Plan 1 Mbps
    </option>
     <option value="4" >Plan 4 Mbps
    </option>
     <option value="6" >Plan 6 Mbps
    </option>
      </select></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="18" class="LINK"><input name="button" type="submit" class="boton_intranet" id="button" value="Crear Cliente PPPoE" /></td>
    <td><span class="LINK">
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "none", {validateOn:["change"], minChars:1, maxChars:0});
...
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "ip");
</script>
</body>
</html>
