...
<li><a href="../Informaciones/informaciones.php" >Informaciones</a></li>
  ...
  <tr>
    ...
    <td width="118" class="Sub_menu"><a href="ticket_abiertos.php" class="Menu" id="ok">Abiertos
...
?>
  ...
  <div id="ticket_resultado">
    <div id="titulo_ticket_abierto">
      <div id="titulo_ticket_abiertos_left">Ticket Abiertos (Todos)</div>
    </div>
    <p>&nbsp;</p>
...
echo "<td><div id='divi3'><a  href='comprobacion_editar1.php?cliente=$row[1]&numero=$row[13]'><center>E</a></div></center></td> \n";
echo "<td><div id='divi2'><a   href='comprobacion_eliminar1.php?cliente=$row[1]&numero=$row[13]'><center>X</a></div></center></td> \n";
...
echo "</table></center> \n";
	...
	echo "No tienes Ticket Abiertos";
...
?></p>
   ...
   if ($id==1){
	   ...
	   <a  name='link' href='comprobacion_eliminado1.php?cliente=$id3&numero=$id2' >SI</a>"." &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp        "."<a  name='link' href='comprobacion_eliminado1.php' >NO</a>
	   </center></div>
	   ";
