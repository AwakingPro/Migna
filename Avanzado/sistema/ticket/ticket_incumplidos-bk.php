...
?>
    ...
    <td width="123" class="Sub_menu"><a href="ticket_finalizados.php" class="Menu">Revisión
      Terreno <?php $sql8 = "SELECT COUNT(*) FROM TICKET WHERE status='Finalizado' and status='Abierto' ";
$resultado8 = mysql_query($sql8);

$select8=mysql_query("SELECT * FROM TICKET WHERE status='Finalizado'  and status='Abierto'");
...
?>
  ...
  <div id="ticket_resultado">
     <div id="titulo_ticket_abierto">
      <div id="titulo_ticket_abiertos_left">Ticket Incumplidos</div>
      <div id="titulo_ticket_abiertos_right">
        <form action="ticket_incumplidos.php" method="GET">
         
            <select name="ticket_filter" class="formulariochicoselect" id='ticket_filter'>
...
echo "<td><div id='divi2'><a   href='comprobacion_eliminar2.php?cliente=$row[1]&numero=$row[13]&ticket_filter=$ticket_filter'><center>X</a></div></center></td> \n";
...
?></p>
   ...
   if ($id==1){
	   ...
	   <a  name='link' href='comprobacion_eliminado2.php?cliente=$id3&numero=$id2&ticket_filter=$ticket_filter' >SI</a>"." &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp        "."<a  name='link' href='comprobacion_eliminado2.php?&ticket_filter=$ticket_filter' >NO</a>
	   </center></div>
	   ";
