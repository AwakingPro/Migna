...
SET   prioridad=	'$prioridad',asignar=	'$asignar',status=	'$status' ,fecha_actualizacion=	'$fecha_actualizacion',   resultado=	'$resultado',   estado_factibilidad=	'$seguimiento' WHERE numero='$numero' and cliente='$cliente'");
