...
<div id="top"></div>
 ...
 <?php include '../../include/estructura/menu_sistema.php';?>
  <?php include '../../include/estructura/submenu_sistema_procedimientos.php';?>
...
<a href="procedimientos_ingreso.php"><input type="button" name="agregar" value="Subir Procedimiento" class="boton" OnClick="../../../sistema/procedimientos_ingreso.php"> </a>
 </div>
  ...
  $sql_abiertos2=mysql_query("SELECT * FROM SIS_procedimientos ");
...
echo "<td bgcolor='#C9101A'><font color='#FFFFFF'><center>Descargar</center></td> \n";
...
echo "<td><div id='divi'>
<a href='comprobacion_pdf_proc.php?proc=$row[3]'><center><img src='../../imagenes/pdf1.png'</a></div></center></td> \n";
...
$sql = "SELECT COUNT(*) FROM SIS_procedimientos  ";
$resultado = mysql_query($sql);

$select=mysql_query("SELECT * FROM SIS_procedimientos ");
