...
<div id="datos_com"><strong>Editar Registro de Pago: </strong><br />
      <br />
 </div>
  <?php while($row=mysql_fetch_array($sql_aviso)){?>
<form action="comprobacion_actualizar_historial_pago.php" method="post">
<table width="1169" border="0">
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="monto" type="text" value='<?php echo $row['monto']; ?>' class="formulario_chico_intranet_editar" id="aviso" />
      <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    <td width="239"><span class="style1 style2">KW</span></td>
    <td width="22">:</td>
    <td colspan="2"><span id="sprytextfield2">
    <label for="fecha_contratacion"></label>
    <input name="kw" type="text" class="formulario_chico_intranet_editar"  value='<?php echo $row['kw']; ?>' />
    <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield3">
      ...
      <input name="fecha_pago" type="text" class="formulario_chico_intranet_editar" id="datepicker2" value='<?php echo $row['fecha_pago']; ?>' />
