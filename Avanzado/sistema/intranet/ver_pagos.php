...
$sql_aviso=mysql_query("SELECT * FROM Pagos_Luz WHERE id='$id_pago'  LIMIT 1");
...
<div id="datos_com"><strong>+ Info sobre el Registro de Pago:</strong>  <br />
      <br />
 </div>
...
<table width="1141" border="0">
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="proveedor" type="text" class="formulario_grande_intranet" id="aviso" value='<?php echo $row['direccion']; ?>' readonly="readonly" />
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
  </tr>
  <tr>
    <td width="159"><span class="style1 style2">Contacto</span></td>
    <td width="19">:</td>
    <td colspan="2"><span id="sprytextfield2">
    <label for="fecha_contratacion"></label>
    <input name="aviso3" type="text" class="formulario_grande_intranet" id="aviso2" value='<?php echo $row['contacto']; ?>' readonly="readonly" />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
  </tr>
  <tr>
    <td><span class="style1 style2">Teléfono</span></td>
    <td>:</td>
    <td colspan="2"><input name="aviso4" type="text" class="formulario_grande_intranet" id="aviso3" value='<?php echo $row['telefono']; ?>' readonly="readonly" /></td>
  </tr>
  <tr>
    <td>Correo</td>
    <td>:</td>
    <td colspan="2"><input name="aviso5" type="text" class="formulario_grande_intranet" id="aviso4" value='<?php echo $row['correo']; ?>' readonly="readonly" /></td>
  </tr>
  <tr>
    ...
    <input name="fecha_expiracion" type="text" readonly="readonly" class="formulario_chico_intranet"id="fecha_expiracion" value='<?php echo $row['fecha_proximo_pago']; ?>' />
      <input name="aviso2" type="hidden" class="formulariochicoEDIT"id="fecha_expiracion" value='<?php echo $row['aviso']; ?>' />
       <input name="id_header" type="hidden" class="formulariochicoEDIT"id="fecha_expiracion" value='3' />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
    </tr>
  <tr>
    <td>Comentario</td>
