...
<div id="busqueda_clientes">
	<div id="datos_com"><strong>Administrador de Tareas</strong>  <br />
    	<br />
 	</div>
    ...
    <table id="example" class="display" cellspacing="0" width="100%">
    	<thead>
            <tr>
                ...
                <th><center>Descripcion Tarea</center></th>
                <th><center>Fecha Inicio</center></th>
                <th><center>Fecha Termino</center></th>
        	...
        	<tr>
        		<?php $ticket=mysql_query("SELECT * FROM TASK ");
				...
				<td><center><a href="comprobacion_ver_aviso.php?id_aviso=<?php echo $row[0]; ?>"><img src='../../../imagenes/ver.png' /></a></center></td>
           		<td><center><a href="comprobacion_editar_aviso.php?id_aviso=<?php echo $row[0]; ?>"><img src='../../../imagenes/editar.png' /></a></center></td>
            	<td><center>
             <a href='comprobacion_eliminar_aviso.php?id_aviso=<?php echo $row[0]; ?>&aviso=$row[1]'><img src='../../../imagenes/eliminar.png' /></a></center></td>
     		</tr>
     		<?php } ?> 
     	</tbody>
    </table>
...
<center><form  action="crear_tarea.php" method="post">
<input type="hidden" name="id_header" value="6" />
<input name="agregar" type="submit" class="boton_intranet" value="Crear Nuevo Tarea" />
</form>
  </center>
  <br />
  <br />
