...
<div id="datos_com"><strong>Editar Registro : </strong><br />
      <br />
 </div>
  <?php while($row=mysql_fetch_array($sql_aviso)){?>
<form action="comprobacion_actualizar_pago.php" method="post">
<table width="867" border="0">
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="estacion" type="text" value='<?php echo $row['estacion']; ?>' class="formulario_grande_intranet_editar" id="aviso" />
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="direccion" type="text" value='<?php echo $row['direccion']; ?>' class="formulario_grande_intranet_editar" id="aviso" />
      <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    <td width="155"><span class="style1 style2">Contacto</span></td>
    <td width="10">:</td>
    <td colspan="2"><span id="sprytextfield2">
    <label for="fecha_contratacion"></label>
    <input name="contacto" type="text" class="formulario_grande_intranet_editar"  value='<?php echo $row['contacto']; ?>' />
    <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    <td>Teléfono</td>
    ...
    <input name="telefono" type="text" class="formulario_grande_intranet_editar" id="telefono" value='<?php echo $row['telefono']; ?>' />
    <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    <td>Correo</td>
    ...
    <input name="correo" type="text" class="formulario_grande_intranet_editar" id="correo" value='<?php echo $row['correo']; ?>'/>
    <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    ...
    <input name="fecha_proximo_pago" type="text" class="formulario_chico_intranet_editar" id="datepicker2" value='<?php echo $row['fecha_proximo_pago']; ?>' />
