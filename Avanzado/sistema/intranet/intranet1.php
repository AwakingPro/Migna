...
" class="Menu10"> Salir </a>
 ...
 <?php include '../../../include/estructura/menu_intranet.php';?>
  ...
  <div id="resumen_general">
    <p>Bienvenido al Módulo de Intranet</p>
    <p>Intranet es una interfaz que permita a los usuarios de la empresa 
puedan generar y consultar información en tiempo real, otorga credibilidad al proceso 
administrativo de clientes para el area de SOPORTE.  Esto también permite tener los datos actualizados
en nuestro software.</p>
