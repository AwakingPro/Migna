...
<div id="datos_com"><strong>+ Info sobre el Aviso:</strong>  <br />
      <br />
 </div>
...
<table width="917" border="0">
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="aviso" type="text" class="formulario_grande_intranet" id="aviso" value='<?php echo $row['aviso']; ?>' readonly="readonly" />
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="proveedor" type="text" class="formulario_grande_intranet" id="aviso" value='<?php echo $row['proveedor']; ?>' readonly="readonly" />
      <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span><span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
  </tr>
  <tr>
    ...
    <input name="fecha_contratacion" type="text" class="formulario_chico_intranet" id="fecha_contratacion" value='<?php echo $row['fecha_contratacion']; ?>' readonly="readonly" />
  ...
  <tr>
    ...
    <input name="fecha_expiracion" type="text" class="formulario_chico_intranet"id="fecha_expiracion" value='<?php echo $row['fecha_expiracion']; ?>' readonly="readonly" />
      <input name="aviso2" type="hidden" class="formulariochicoEDIT"id="fecha_expiracion" value='<?php echo $row['aviso']; ?>' />
       <input name="id_header" type="hidden" class="formulariochicoEDIT"id="fecha_expiracion" value='5' />
    <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span></td>
    </tr>
  <tr>
    <td>Comentario</td>
    <td rowspan="2"><label for="textarea"></label>
      <textarea name="textarea" cols="45" rows="7" readonly="readonly" class="formulario_grande_intranet" id="textarea"><?php echo $row['comentario']; ?></textarea></td>
    <td rowspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><input name="btn_submit" type="submit" class="boton_intranet" value="Volver a Avisos"></td>
    <td width="399">&nbsp;</td>
    <td width="284">&nbsp;</td>
  </tr>
</table></form><?php }?>
