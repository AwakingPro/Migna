...
<div id="datos_com"><strong>Registrar Nuevo Pago:</strong>  <br />

 
</div>
<form action="comprobacion_registrar_pago_final.php" method="post">
  <table width="946" height="352" border="0">
  <tr>
    <td>Nombre del Registro</td>
    <td><span class="style1 style2">:</span></td>
    <td colspan="2"><span id="sprytextfield1">
      <label for="aviso"></label>
       <?php while($row=mysql_fetch_array($sql_aviso)){?>
      <input name="estacion" type="text" class="formulario_grande_intranet_fijo" id="aviso" value='<?php echo $row['estacion'];  }?>' readonly="readonly" />
  ...
  <tr>
    ...
    <td colspan="2"><span id="sprytextfield1">
      ...
      <input name="monto" type="text" class="formulario_chico_intranet" id="direccion" />
  ...
  <tr>
    <td width="207"><span class="style1 style2">KW</span></td>
    <td width="10"><span class="style1 style2">:</span></td>
    <td colspan="2"><span id="sprytextfield2">
    <label for="fecha_contratacion"></label>
    <input name="kw" type="text" class="formulario_chico_intranet" id="fecha_contratacion" />
    <span class="textfieldRequiredMsg">X</span><span class="textfieldMinCharsMsg">X</span><span class="textfieldMaxCharsMsg">X</span></span></td>
  </tr>
  <tr>
    <td><span class="style1 style2">Fecha  Pago</span></td>
    <td><span class="style1 style2">:</span></td>
    <td colspan="2"><span id="sprytextfield3">
      <label for="fecha_expiracion"></label>
      <input name="fecha_pago" type="text" class="formulario_chico_intranet" id="datepicker" placeholder="Formato : 2015-02-02"/>
  ...
  <tr>
    <td><input name="btn_submit" type="submit" class="boton_intranet" value="Registrar Pago" /></td>
    <td>&nbsp;</td>
    <td width="622">
