...
include("file:///Y|/services/config.php");
...
<a href="procedimientos_ingreso_net.php"><input type="button" name="agregar" value="Subir Procedimiento" class="" OnClick="ingresar_manual.php"> </a>
 </div>
...
if (mysql_num_rows($select)>0){
 ...
 echo "Cantidad de Registros = ".$row[0]; }
   ...
   if ($id==1){
	   ...
	   <input type='hidden' name='menu' value='$id3'>
  ...
  <?php include 'file:///Y|/include/estructura/foot.php';?>
