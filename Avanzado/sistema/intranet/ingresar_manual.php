...
$sql=mysql_query("SELECT nombre FROM SIS_manual ");
...
<?php include '../../../include/estructura/banner.php';?>
 <?php include '../../../include/estructura/menu_intranet.php';?>
  ...
  <div id="rpe"> <p class="iconos_top">
	...
	<div id="titulo_ticket_abiertos_left"><span class="iconos_top">Ingresar Manual </span></div>
  ...
  <tr>
    <td width="8">&nbsp;</td>
    <td width="126">Nombre de Manual</td>
  ...
  <tr>
	...
	if (empty($id)){}
		...
		echo "<div id='dialog' title='Manual'>Registro Ingresado Exitosamente.</div>";
