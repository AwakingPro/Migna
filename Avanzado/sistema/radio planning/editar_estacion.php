...
<?php include '../../../include/estructura/banner.php';?>
 ...
 <?php include '../../../include/estructura/submenu_radio_planning_busqueda_estacion.php';?>
  ...
  <div id="rpe"> <p class="iconos_top">
	...
	<p class="iconos_top">
    <form method="post" enctype="multipart/form-data"  action="comprobacion_guardar_estacion.php" >
     <table width="687" border="0">
  <tr>
    <td width="8">&nbsp;</td>
    <td width="133">&nbsp;</td>   <?php while($row = mysql_fetch_array($sql)){ ?>
    <td colspan="2">&nbsp;</td>
    <td width="46">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td><input name="estacion2" type="hidden" value="<?php echo $row['estacion'];?>" class="iconos_top" id="course2" size="40" />
    <td>Estación</td>
    <td colspan="2"><span id="sprytextfield1">
    <label for="estacion"></label>
    <input name="estacion" type="text" class="formulario" id="estacion" VALUE="<?php echo $row['estacion'];?>" />
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" class="formulariochico" value="Guardar Registro"   /></td>
    <td width="90"><input type="reset" class="formulariochico"   value="Borrar valores escritos"   /></td>
    <td width="226">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
    </table> </FORM>
    ...
    if (empty($id)){}
		  ...
		  if ($id==1){
		   echo "<div id='dialog' title='Editar Estación'><center>Regsitro Guardado exitosamente
	   </center></div>
	   ";
