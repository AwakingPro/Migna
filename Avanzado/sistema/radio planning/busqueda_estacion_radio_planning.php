...
$().ready(function() {
	$("#course").autocomplete("busqueda_estacion2.php", {
		width: 260,
		matchContains: true,
		//mustMatch: true,
		//minChars: 0,
...
<div id="rp"><FORM name=tuformulario autocomplete="off" ACTION="comprobacion_resultado_estacion.php" METHOD="POST">
              <div id="datos_com"><strong>Busqueda Estacion</strong>  <br /><br /></div>
<p class="Nota">Nota : Escriba las iniciales o coincidencia de caractéres en el campo de busqueda.</p>        
        <table width="856" border="0">
  <tr>
    <td width="136"> Estación | Repetidor</td>
    <td width="662"><input name="estacion" type="text" class="formulario_grande_intranet" id="course" size="40" />
