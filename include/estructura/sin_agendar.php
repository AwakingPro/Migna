<div id="contacto_1"><table width="1125" border="0" >
  <tr>
    ...
    <a href="factibilidades_pendientes.php" title="Instalaciones pendientes de asignacion a Terreno" class="Submenu_principal">Sin Agendar
...
?>
    ...
    <td width="108" class="Menu"><a href="factibilidades_por_instalar.php" title="Solicitudes por Instalar y en Ruta" class="Menu">En Ruta
...
?>
&nbsp;</a></td>
    <td width="134" class="Menu"><a href="factibilidades_espera.php" title="Solicitudes En Espera por decision Comercial"  class="Menu">Por Instalar 
          <?php $user8=mysql_query("SELECT nombre FROM usuarios WHERE usuario='$usuario'");
...
?>
    ...
    <td width="131" class="Menu"><a href="factibilidades_espera.php" title="Solicitudes En Espera por decision Comercial"  class="Menu">Negociación <?php $user8=mysql_query("SELECT nombre FROM usuarios WHERE usuario='$usuario'");
...
&nbsp;</a></td>
 ...
 while($row=mysql_fetch_array($user9)){
     	$user9 =$row['nombre'];
	    global $user9; 
	}$sql9 = "SELECT COUNT(*) FROM TICKET WHERE  status='Cerrado' and subtipo='Factibilidad'  and  estado_factibilidad='Rechazado' and resultado='Positiva'";
$resultado9 = mysql_query($sql9);

$select9=mysql_query("SELECT * FROM TICKET WHERE  status='Cerrado' and subtipo='Factibilidad'  and  estado_factibilidad='Rechazado' and resultado='Positiva'");
if (mysql_num_rows($select9)>0){
 $row = mysql_fetch_array($resultado9);
 echo "("; echo $row[0]; echo ")"; }
else {echo "";}
...
?>
&nbsp;</a></td>
    <td width="253" class="Menu"><a href="asignar_factibilidades.php" class="Menu" title="Solicitudes Asignadas a mi Usuario"> A <?php echo $user8;?>
