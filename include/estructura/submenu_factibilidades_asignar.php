<div id="contacto_1"><table width="1125" border="0" >
  <tr>
    ...
    <a href="factibilidades_pendientes.php" title="Instalaciones pendientes de asignacion a Terreno" class="Menu">Sin Agendar
...
?>
&nbsp;</a></td>
    <td width="253" class="Menu"><a href="asignar_factibilidades.php" class="Submenu_principal" title="Solicitudes Asignadas a mi Usuario"> A <?php echo $user8;?>
