	...
	$loginFoundUser = mysql_num_rows($LoginRS);
  	if ($loginFoundUser) 
  	{
        ...
        { 
            ...
            $ced = mysql_query("SELECT Id_Cedente FROM Usuarios WHERE usuario = '$usuario_sis' LIMIT 1");
            while($row = mysql_fetch_array($ced))
            {
                $_SESSION['cedente'] = $row[0];
            }    
...
<body>
	<div id="container" class="cls-container">
		...
		<div class="cls-header cls-header-lg">
			<div class="cls-brand">
				<a class="box-inline" href="index.php">
					...
					<span class="brand-title">  DATA - Software de Administración de Datacenter <span class="text-thin"></span></span>
				</a>
			</div>
		</div>
		<!--===================================================-->
		...
		<div class="cls-content">
            ...
            <br>
            <?php 
            if($_GET['id']==1){ echo "<span class='text-danger'>Usuario o Contraseña Incorrectos!</span>"; } else {}?>
					</form>
				</div>
			</div>
			<div class="pad-ver">
