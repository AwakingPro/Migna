$(document).ready(function() 
{
 	...
 	$('#crear_estrategia').submit(function(e)
    {
        ...
        else
        {
		    ...
		    var cedente = $('#cedente').val();
		    console.log(usuario);
		    var datos_estrategia = 'nombre_estrategia='+nombre_estrategia+'&comentario_estrategia='+comentario_estrategia+'&tipo_estrategia='+tipo_estrategia+'&cedente='+cedente+'&usuario='+usuario;
     		$.ajax(
	   		{
			    type: "POST",
