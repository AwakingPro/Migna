...
$stream = ssh2_exec($connection, 'ubntbox mca-status | grep "signal"');
while(!feof($stream)) {
...
$ccq_live3=$ccq_live2;
echo $ccq_live3.$ip."<br>";
	 $sql_update=mysql_query("UPDATE INT_radio_planning SET senal_live='$ccq_live3'  WHERE  ip='$ip' ");
}
