            ...
            <div id="content-container">
                ...
                <div id="page-content">
                             ...
                             <div class="col-sm-6">
                                    ...
                                    <h2 class="panel-title">Generar Orden de Salida</h2>
                                    </div>
                                    <div class="panel-body">
                                                <div class="form-group">
                                                    <form action="#" method="POST" name="ingreso_orden" id="ingreso_orden">
                                                </div>
                                                 <div class="form-group">
                                                    <input type="text" name="comentario" id="comentario" placeholder="Comentario" class="form-control">
                                                    <input type="hidden" name="responsable" id="responsable" value="<?php echo $usuario; ?>">
<br>
                             ...
                             <div id="ocultar">    
                                    ...
                                    <div class="panel" id='padre'>
                                    <div class="panel-heading">
                                    <h2 class="panel-title">Buscar Activo</h2>
                                    </div>
                                    <div class="panel-body">
                                                <div class="form-group">
                                                    <form action="#" method="POST" name="buscar" id="buscar">
                                                    <div id="desactivado">
                                                    <input type="text" disabled="disabled" name="mac" id="mac" placeholder="Mac o Numero de Serie" class="form-control">
                                                    </div>
                                                    <input type="hidden" name="responsable" id="responsable" value="<?php echo $usuario; ?>">
                                                    <br>
                                                    <div id="id_orden"></div>
                                    ...
                                    <div class="panel" id='padre'>
                                    <div class="panel-heading">
                                    <h2 class="panel-title">Asignar Responsable y Bodega</h2>
                                    </div>
                                    <div class="panel-body">
                                              <div class="form-group">
                                                     <form action="#" method="POST" id="responsables" name="responsables">

                                                    <select class="selectpicker" id="responsable" name="responsable" data-live-search="true" data-width="100%">
                                                        <option value="0">Seleccione Responsable</option>

                                                        <?php $result=mysql_query("SELECT nombre FROM usuarios");
                                                ...
                                                <div class="form-group">
                                                    <select class="selectpicker" id="bodega" name="bodega" data-live-search="true" data-width="100%">
                                             <option value="0">Seleccione Bodega</option>

                                                        <?php $result=mysql_query("SELECT bodega FROM INV_bodega");
                                                    while($row=mysql_fetch_array($result)){
                                                    ?>
...
<br>
                                               ...
                                               <button id="demo-alert-noty" class="btn btn-primary btn-block" type="submit">Guardar</button>
                             ...
                             <div class="panel" id='padre'>
                             <div class="panel-heading">
                                     <h2 class="panel-title">Resultado de la Busqueda:</h2>
                                    </div>
                                    <div class="panel-body">
                                    <div id="error"></div>
                                    <br>
                                    <div id="mostrar">Realice una busqueda :</div>
                                    <div id='oculto'>
						            ...
						            <li>
                                      ...
                                      <li>
						                ...
						                <ul class="collapse in">
                                            ...
                                            <li class="active-link"><a href="#">Egresos</a></li>
