    ...
    <div id="container" class="effect mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--===================================================-->
                <div id="page-content">
                    <form action="#" method="POST" id="ingreso" name="ingreso">
                    <div class="panel" id='padre'>
                             <div class="panel-heading">
                                     <h2 class="panel-title">Ingresar Activo</h2>
                                    </div>
                                    <div class="panel-body">
                             <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label class="control-label focusedInput" >Mac</label>
                             ...
                             <div class="row">               
                                             <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker" id="tipo" name="tipo" data-live-search="true" data-width="100%">
                                                        <?php $result=mysql_query("SELECT tipo FROM INV_tipo");
                                             ...
                                             <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker" id="modelo" name="modelo"  data-live-search="true" data-width="100%">
                                                    <?php $result=mysql_query("SELECT modelo FROM INV_modelo");
                                                    while($row=mysql_fetch_array($result)){
                                                    ?>
                                             ...
                                             <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker" id="proveedor" name="proveedor"  data-live-search="true" data-width="100%">
                                                            <?php $result=mysql_query("SELECT nombre FROM INV_proveedor");
                                                    while($row=mysql_fetch_array($result)){
                                                    ?>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label for="sel1">Ubicación</label>
                                                    <select class="selectpicker" id="ubicacion" name="ubicacion"  data-live-search="true" data-width="100%">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                    <br><button class="btn btn-primary btn-block" type="submit">Ingresar Activo</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
						            ...
						            <li>
                                      ...
                                      <li >
						                ...
						                <ul class="collapse in">
						                    <li class="active-link"><a href="#">Ingresos</a></li>
