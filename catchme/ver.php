    ...
    <div id="container" class="effect mainnav-lg">
            ...
            <div id="navbar-container" class="boxed">
                ...
                <div class="navbar-header">
                    <a href="index.php" class="navbar-brand">
                     <br>
                            <span class="brand-text">&nbsp;&nbsp;&nbsp;<i class="ion-pin"></i>  Catchme</span>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Ubicación</h1>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Ver Ubicación</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li>
						                ...
						                <ul class="collapse in ">
						                    <li class="active-link"><a href="ver.php">Ver Ubicación</a></li>
						            ...
						            <li>
						                <a href="#">
						                    <i class="psi-dollar-sign-2"></i>
						                    <span class="menu-title">Modulo 2</span>
											<i class="arrow"></i>
						                </a>
						            ...
						            <li>
						                <a href="#">
						                    ...
						                    <span class="menu-title">Modulo 3</span>
											<i class="arrow"></i>
						                </a>
